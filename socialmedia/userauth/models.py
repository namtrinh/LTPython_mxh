...
class Post(models.Model):
    ...
    image = models.ImageField(upload_to='post_images', blank=True, null=True)  # Thêm blank=True, null=True
    video = models.FileField(upload_to='post_videos', blank=True, null=True)  # Cho phép video trống
